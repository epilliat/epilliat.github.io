...
I'm developing [**KernelForge.jl**](https://github.com/epilliat/KernelForge.jl), a Julia package for high-performance GPU algorithms. The goal is to provide efficient, portable implementations of parallel primitives that match the performance of vendor-optimized libraries like NVIDIA's CUB or CUBLAS, while maintaining cross-platform compatibility.
