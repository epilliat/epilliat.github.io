...
I am interested in GPU parallel computing. I'm currently developing a Julia library focused on optimizing fundamental functions like `mapreduce` (for operations such as sum) and `accumulate` (for operations like prefix sum). You can explore my experimental work at my GitHub repository [Luma.jl](https://github.com/epilliat/Luma.jl) for more technical details.
