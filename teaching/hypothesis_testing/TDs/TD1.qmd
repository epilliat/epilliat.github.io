...
3. We observe $10$ students and $X=8$ "cat" answers. Compute the pvalue in this specific case.
...
Let $(X_1, X_2, \ldots, X_n)$ be a sample from an exponential distribution $\mathcal E(\lambda)$. We want to test:
$$
...
1. Compare the p-value if we use a Gaussian approximation of $\sum X_i$ with the TCL.
