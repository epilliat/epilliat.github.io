...
::: {.callout}
- We observe $X=(X_1, \dots, X_{n_1})$ iid  $\mathcal N(\mu, \sigma^2)$. $\mu$, $\sigma$ are **unknown**. $\sigma_0$ is fixed.
...
- We observe $(X_1, \dots, X_{n_1})$ iid  $\mathcal N(\mu_1, \sigma_1^2)$ and $(Y_1, \dots, Y_{n_2})$ iid  $\mathcal N(\mu_2, \sigma_1^2)$.
