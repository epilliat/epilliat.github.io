...
- Group $k$: $(X_{1,k}, \dots, X_{N_k,k}) \in \mathbb R^{N_k}$ are iid $\mathcal N(\mu_k, \sigma)$. Ex: $X_{ik} =$ sallary of $i$ living in region $k$ [[Wooclap](https://app.wooclap.com/events/RQSUIA/questions/67d190bd325561a195e734b3)]
