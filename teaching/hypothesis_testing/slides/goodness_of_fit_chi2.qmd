...
## Change of Degree of Freedom
1. If $P_0$ is **unknown**
2. An that you have to estimate $\ell$ parameters to estimate $\hat P_0$
3. Compute theoretical counts with $\hat P_0$...
4. But decide with $\chi^2(k - 1 - \ell)$
:::
