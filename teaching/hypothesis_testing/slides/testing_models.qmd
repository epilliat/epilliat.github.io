...
[Next: usual distributions](usual_distributions.qmd)
...
We observe $X \in \mathcal X=\mathbb R^n$. We fix [two known distributions $P$ and $Q$]{style="background-color: yellow;"}.
...
Its [power]{style="background-color: yellow;"} is defined as
...
$H_0 = \mathcal P_0=\{P_{\theta}, \theta \in \Theta_0 \}$ is [not a singleton]{style="background-color: orange;"}

. . .

$H_1 = \mathcal P_0=\{P_{\theta}, \theta \in \Theta_0 \}$ is [not a singleton]{style="background-color: orange;"}
...
Its [power function]{style="background-color: yellow;"} is defined as
